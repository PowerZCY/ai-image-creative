...
export async function getMonicaCreatorCopy(locale: string): Promise<MonicaCreatorCopy> {
  ...
  return {
    ...
    promptDetails: t('promptDetails'),
    sessionResults: t('sessionResults'),
    openStudio: t('openStudio'),
    noReference: t('noReference'),
    modelOptions: {
      gptImage: t('modelOptions.gptImage'),
      fluxPro: t('modelOptions.fluxPro'),
      ideogram: t('modelOptions.ideogram'),
      recraft: t('modelOptions.recraft'),
      stableDiffusion: t('modelOptions.stableDiffusion'),
    },
    assistant: {
      ...
      use: t('assistant.use'),
      moreLikeThis: t('assistant.moreLikeThis'),
      ...
      appendDetails: t('assistant.appendDetails'),
