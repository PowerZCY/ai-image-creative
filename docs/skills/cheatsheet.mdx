...
| `NEXT_PUBLIC_STYLE_ICON_COLOR` | UI 图标主色??支持 `purple`、`orange`、`indigo`、`emerald`、`rose`、`clue`、`hose`、`pika` |
| `NEXT_PUBLIC_STYLE_THEME_MODE` | 全站亮暗主题模式??支持 `light-dark-system`、`light-only`、`dark-only` |
